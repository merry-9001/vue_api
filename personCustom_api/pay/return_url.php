...
if($result) {//验证成功
	...
	// echo "<a href='http://localhost:8080/admin/Order'>index</a>";

 echo "<script>alert('付款成功');window.location.href= 'http://47.96.175.28/person_custom/index.html#/order';</script>";
